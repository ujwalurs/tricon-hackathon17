         ...
         <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
          <header class="mdl-layout__header mdl-layout__header--scroll">
                <div class="mdl-layout__header-row">
                    <!-- Title -->
                    <span class="mdl-layout-title">Monetary Donations Received</span>
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link selected-link" href="moneyrev.php">
                ...
                <table class="mdl-data-table mdl-js-data-table mdl-shadow--24dp" style="width: inherit;">
                  <thead>
                    <tr>
                      ...
                      <th class="center-align mdl-data-table__cell--non-numeric">Amount (in Rs.)</th>    
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td class="center-align mdl-data-table__cell--non-numeric">Example Person 1</td>
                      <td class="center-align mdl-data-table__cell--non-numeric"><a href="mailto:example@email.com?subject=[Do-net]%20 Thank%20You%20for%20your%20kind%20gesture">example@sample.com</a></td>
                      ...
                      <td class="center-align mdl-data-table__cell--non-numeric">&#x20B9;&nbsp;10000</td>
                    </tr>
                  </tbody>
                </table>
            </div>
