         ...
         <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
          <header class="mdl-layout__header mdl-layout__header--scroll">
                <div class="mdl-layout__header-row">
                    <!-- Title -->
                    <span class="mdl-layout-title">Donate Money</span>
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link selected-link" href="money.php">
                ...
                <table class="mdl-data-table mdl-js-data-table mdl-shadow--24dp" style="width: inherit;">
                  <thead>
                    <tr>
                      ...
                      <th class="center-align mdl-data-table__cell--non-numeric">Donate</th>    
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td class="center-align mdl-data-table__cell--non-numeric">ABCDEFGHIJKLMNOPQRSTUVWXYZ</td>
                      <td class="center-align mdl-data-table__cell--non-numeric"><a href="mailto:example@email.com?subject=[Do-net]%20 <Your%20subject%20goes%20here>">example@sample.com</a></td>
                      ...
                      <td class="center-align mdl-data-table__cell--non-numeric"><i class="material-icons" style="color: green;">verified_user</i></td>
                      <td class="center-align mdl-data-table__cell--non-numeric">
                          <button type="submit" class="mdl-button mdl-button--accent mdl-js-button mdl-js-ripple-effect" style="font-size: 16px;">
                            Donate <i role="presentation">&nbsp;<img src="images/Indian_Rupee_symbol3.png" width=auto height=18/></i>
                          </button>
                      </td>
                    </tr>
                  </tbody>
