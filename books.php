         ...
         <div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
          <header class="mdl-layout__header mdl-layout__header--scroll">
                <div class="mdl-layout__header-row">
                    <!-- Title -->
                    <span class="mdl-layout-title">Books and Stationary Listing</span>
            ...
            <nav class="mdl-navigation">
                ...
                <a class="mdl-navigation__link selected-link" href="books.php">
          ...
          <main class="mdl-layout__content home_page" style="width: inherit;">
            <div class="ngo-list page-content" style="width: inherit;">
                <table class="mdl-data-table mdl-js-data-table mdl-shadow--24dp" style="width: inherit;">
                  <thead>
                    <tr>
                      <th class="center-align mdl-data-table__cell--non-numeric">Item Description</th>
                  ...
                  <tbody>
                        <?php 
                            while($show=mysqli_fetch_array($bookRes,MYSQLI_ASSOC)) {
                              echo '<tr>
                              ...
                              <td class="center-align mdl-data-table__cell--non-numeric">'.$show[bookID].'</td>
